...
class Feedback(models.Model):
    Diagnostic_Accuracy = models.CharField(max_length=10)
    User_Experience = models.CharField(max_length=10)
    Likelihood_to_recommend = models.CharField(max_length=10)
